...
# Load .env BEFORE importing backend modules – they read API keys at import time.
load_dotenv()
...
app.add_middleware(
    ...
    allow_methods=["*"],
    allow_headers=["*"],
    expose_headers=["X-Driver-Text", "X-Engineer-Text"],
)
...
async def telemetry_endpoint():
    ...
    return JSONResponse(content={
        ...
        "engine_mguh_wear":     state.engine_mguh_wear,
        "engine_es_wear":       state.engine_es_wear,
        "engine_ce_wear":       state.engine_ce_wear,
        "engine_ice_wear":      state.engine_ice_wear,
        "engine_mguk_wear":     state.engine_mguk_wear,
        "engine_tc_wear":       state.engine_tc_wear,
        ...
        "tyre_damage":          state.tyre_damage,
        "brakes_damage":        state.brakes_damage,
        "drs_fault":            state.drs_fault,
        "ers_energy_store_health": state.ers_energy_store_health,
